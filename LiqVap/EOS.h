 ...
 WRDF_LJ() : EOS()
    {
      ...
      al_[0][0] =  7.690224838392756279e-01;
      al_[0][1] = -3.153910169943185959e+00;
      al_[0][2] =  2.886406073436768693e+00;
      al_[0][3] =  5.170749028341210085e+00;
      al_[0][4] = -1.044622980663629441e+01;
      al_[0][5] =  8.656382956332409062e-01;

      al_[1][0] =  3.269747272846510011e+00;
      al_[1][1] = -7.773917981058953330e+01;
      al_[1][2] =  3.685941276727217542e+02;
      al_[1][3] = -7.230317930487650528e+02;
      al_[1][4] =  6.465538365485742816e+02;
      al_[1][5] = -2.193018472879539331e+02;

      al_[2][0] = -8.293526173216596575e+00;
      al_[2][1] =  3.778727621371398868e+02;
      al_[2][2] = -1.929641574600540707e+03;
      al_[2][3] =  3.888378430601394939e+03;
      al_[2][4] = -3.522436436983288786e+03;
      al_[2][5] =  1.219511341403025654e+03;

      al_[3][0] = -3.188581072468004507e+01;
      al_[3][1] = -5.978745233526092306e+02;
      al_[3][2] =  3.874727611676720244e+03;
      al_[3][3] = -8.352099111519108192e+03;
      al_[3][4] =  7.764536367165250340e+03;
      al_[3][5] = -2.720454410705084683e+03;

      al_[4][0] =  1.022571045500056499e+02;
      al_[4][1] =  3.492984522056419223e+02;
      al_[4][2] = -3.783550535487431262e+03;
      al_[4][3] =  8.937046874892746928e+03;
      al_[4][4] = -8.548363392920171464e+03;
      al_[4][5] =  3.013089322044620531e+03;
      
      al_[5][0] = -9.717532400121930891e+01;
      al_[5][1] = -4.109700355637258440e+00;
      al_[5][2] =  1.783386606546049052e+03;
      al_[5][3] = -4.738687139283345459e+03;
      al_[5][4] =  4.672478415816356573e+03;
      al_[5][5] = -1.647794570675797786e+03;

      al_[6][0] =  3.112982250741344359e+01;
      al_[6][1] = -4.474045918417971279e+01;
      al_[6][2] = -3.155759031266126726e+02;
      al_[6][3] =  9.856584906924986171e+02;
      al_[6][4] = -1.004955570487645673e+03;
      al_[6][5] =  3.532964212447155319e+02;

      av_[0][0] =  1.913953634512916580e+01;
      av_[0][1] = -9.281401783897453583e+01;
      av_[0][2] =  1.519155407017670996e+02;
      av_[0][3] = -9.934404456707432018e+01;
      av_[0][4] =  1.688354554648334727e+01;      
      av_[0][5] = 0.0; 

      av_[1][0] = -2.126548764308993486e+04;
      av_[1][1] =  7.537646877748279076e+04;
      av_[1][2] = -1.002381004176654824e+05;
      av_[1][3] =  5.929341241393546807e+04;
      av_[1][4] = -1.316604908322055599e+04;
      av_[1][5] =  0.0;
  ...
  { 
      ...
      for(int n=2; n<=8;n++)
	for(int m=-3; m<=2; m++)
	  a += kT*(density < critical_density_ ? av_[n-2][m+3] : al_[n-2][m+3])*pow(density,n-1)*pow(kT,-m);
      return a;
  }
  ...
  virtual double dphix_dx(double density, double kT) const 
  {
      ...
      for(int n=2; n<=8;n++)
	for(int m=-3; m<=2; m++)
	  a += kT*(density < critical_density_ ? av_[n-2][m+3] : al_[n-2][m+3])*(n-1)*(n-2 < 0 ? 0 : (n-2 == 0 ? 1 : pow(density,n-2)))*pow(kT,-m);
      return a;
  }
  ...
  virtual double dphix_dx2(double density, double kT) const
  {
      ...
      for(int n=2; n<=8;n++)
	for(int m=-3; m<=2; m++)
	  a += kT*(density < critical_density_ ? av_[n-2][m+3] : al_[n-2][m+3])*(n-1)*(n-2)*(n-3 < 0 ? 0 : (n-3 == 0 ? 1 : pow(density,n-3)))*pow(kT,-m);
      return a;    
  }
  virtual double dphix_dx3(double density, double kT) const 
  {
      ...
      for(int n=2; n<=8;n++)
	for(int m=-3; m<=2; m++)
	  a += kT*(density < critical_density_ ? av_[n-2][m+3] : al_[n-2][m+3])*(n-1)*(n-2)*(n-3)*(n-3 < 0 ? 0 : (n-3 == 0 ? 1 : pow(density,n-4)))*pow(kT,-m);
      return a;        
  }
  ...
  double al_[7][6];
  double av_[7][6];
  const double critical_density_ = 0.32; // Tc = 1.04
};
