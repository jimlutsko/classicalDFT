...
int main(int argc, char** argv)
{
  ...
  double borderDensityScaleFactor = 1;
  ...
  options.addOption("BorderDensityScaleFactor", &borderDensityScaleFactor);
  ...
  cout << "\tmin = " << bmin << endl;
  cout << "\tave = " << bav << endl;
  cout << "\tDev = " << bmax-bav <<  " to " << bmin-bav << endl;
  cout << "\tRescaling to " << bav*borderDensityScaleFactor << endl;
  ...
  log2 << "#\tmin = " << bmin << endl;
  log2 << "#\tave = " << bav << endl;
  log2 << "#\tDev = " << bmax-bav <<  " to " << bmin-bav << endl;
  log2 << "#\tRescaling to " << bav*borderDensityScaleFactor << endl;

  bav *= borderDensityScaleFactor;
  ...
  fireMinimizer_Mu minimizer(dft, theDensity, 0.0);


  minimizer.setFrozenBoundaryFlag(true);
